 ...
 * All rights reserved
 */
public class EsDeleteStatementVisitor implements StatementVisitor {
    private Context context;

    public EsDeleteStatementVisitor(Context context) {
    ...
    public void visit(Delete delete) {
        DeleteBuilder deleteBuilder = new DeleteBuilder(delete, context);
