 ...
 * All rights reserved
 */
public class EsInsertStatementVisitor implements StatementVisitor {
    private Context context;

    public EsInsertStatementVisitor(Context context) {
    ...
    public void visit(Insert insert) {
        InsertBuilder insertBuilder = new InsertBuilder(insert, context);
